...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(e,t,n){return new ki({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ra,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(){return new ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function to(){return new ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
	...
	`}var ro=class extends Lt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=xs(i,i.VERTEX_SHADER,y),S=xs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ds(i,x,`vertex`),n=Ds(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function ll(){let e=rl(20260924),t=[],n=(e,t,n)=>(n*Gc+t)*Wc+e;for(let n=0;n<Kc;n++)for(let r=0;r<Gc;r++)for(let i=0;i<Wc;i++)t.push({x:(i/10-.5)*qc+(e()-.5)*.34,y:(r/5-.5)*Jc+(e()-.5)*.3,z:-(n/4)*Yc+(e()-.5)*.36,fase:e()*Math.PI*2,vel:.14+e()*.22});let r=[],i=[],a=[],o=[],s=[];for(let e=0;e<Kc;e++){for(let s=0;s<Gc;s++)for(let c=0;c<Wc;c++){let l=t[n(c,s,e)];r.push(l.x,l.y,l.z),i.push(l.fase),a.push(l.vel),o.push(1)}s.push(r.length/3)}let c=new _r;c.setAttribute(`position`,new ar(r,3)),c.setAttribute(`aFase`,new ar(i,1)),c.setAttribute(`aVel`,new ar(a,1)),c.setAttribute(`aAmp`,new ar(o,1));let l=[],u=[],d=[],f=[],p=[],m=[],h=[],g=(e,t,n,r,i)=>{l.push(e.x,e.y,e.z,t.x,t.y,t.z),u.push(e.fase,t.fase),d.push(e.vel,t.vel),f.push(i,i),p.push(0,1),m.push(n,n),h.push(r,r)},_=(e,t,n)=>({x:e,y:t,z:n,fase:0,vel:0});for(let e=-6;e<=tl;e++){let t=tl*el;g(_(e*el,$c,-9.600000000000001),_(e*el,$c,t),-1,.5,0),g(_(-9.600000000000001,$c,e*el),_(t,$c,e*el),-1,.5,0)}let v=[];for(let r=0;r<Kc;r++){for(let i=0;i<Gc;i++)for(let a=0;a<Wc;a++){let o=t[n(a,i,r)],s=t=>t%3==0?e():-1;a+1<Wc&&g(o,t[n(a+1,i,r)],s(a+i+r),1,1),i+1<Gc&&g(o,t[n(a,i+1,r)],-1,.72,1),r+1<Kc&&g(o,t[n(a,i,r+1)],s(a+i+r+2),.85,1)}v.push(l.length/3)}let y=new _r;return y.setAttribute(`position`,new ar(l,3)),y.setAttribute(`aFase`,new ar(u,1)),y.setAttribute(`aVel`,new ar(d,1)),y.setAttribute(`aAmp`,new ar(f,1)),y.setAttribute(`aT`,new ar(p,1)),y.setAttribute(`aLlavor`,new ar(m,1)),y.setAttribute(`aBase`,new ar(h,1)),{nodes:c,enllacos:y,tallNodes:s,tallEnllacos:v}}function ul(e,t,n,r=34){let i=2*Math.sqrt(r)*.82;e.vel+=((t-e.valor)*r-e.vel*i)*n,e.valor+=e.vel*n}function dl({onFalla:e}){let t=r(),n=(0,i.useRef)(null);return(0,i.useEffect)(()=>{let r=n.current;if(!r)return;let i;try{i=new Hc({canvas:r,alpha:!0,antialias:!1,powerPreference:`low-power`})}catch{e();return}let a=()=>{try{let e=i.getContext(),t=e.getExtension(`WEBGL_debug_renderer_info`);if(!t)return!1;let n=String(e.getParameter(t.UNMASKED_RENDERER_WEBGL)||``);return/swiftshader|llvmpipe|software|basic render/i.test(n)}catch{return!1}},o=()=>Math.min(window.devicePixelRatio||1,1.5);i.setPixelRatio(o()),i.setClearAlpha(0);let s=nl(),c=s.clone().lerp(new Z(1,1,1),.55),l={uTemps:{value:0},uAmp:{value:.09},uProp:{value:Zc},uLluny:{value:Qc},uForca:{value:1},uColor:{value:s},uPols:{value:c},uPunt:{value:16*o()}},u=ll(),d=new ki({uniforms:l,vertexShader:al,fragmentShader:ol,transparent:!0,depthTest:!1,depthWrite:!1,blending:2}),f=new ki({uniforms:l,vertexShader:sl,fragmentShader:cl,transparent:!0,depthTest:!1,depthWrite:!1,blending:2}),p=new Cn,m=new hn,h=new si(u.enllacos,f),g=new pi(u.nodes,d);m.add(h),m.add(g),m.position.x=.5,p.add(m);let _=new aa(50,1,.1,40);_.position.set(0,0,Xc);let v=()=>{let e=r.getBoundingClientRect(),t=Math.max(1,Math.round(e.width)),n=Math.max(1,Math.round(e.height));_.aspect=t/n,_.updateProjectionMatrix(),i.setSize(t,n,!1)};if(v(),t){i.render(p,_);let e=()=>{v(),i.render(p,_)};return window.addEventListener(`resize`,e),()=>{window.removeEventListener(`resize`,e),u.nodes.dispose(),u.enllacos.dispose(),d.dispose(),f.dispose(),i.dispose()}}let y={valor:0,vel:0},b={valor:0,vel:0},x={valor:0,vel:0},S=0,C=0,w=0,T=0,E=0,D=0,O=!0,k=16.7,A=0,j=0;a()&&(j=1,i.setPixelRatio(1),l.uPunt.value=16,v());let M=()=>{j===0?(j=1,i.setPixelRatio(1),l.uPunt.value=16,v()):j===1?(j=2,u.nodes.setDrawRange(0,u.tallNodes[3]),u.enllacos.setDrawRange(0,u.tallEnllacos[3])):j===2&&(j=3),A=0,k=16.7},ee=e=>{T=0;let t=E?(e-E)/1e3:1/60;E=e,(!(t>0)||t>.25)&&(t=1/60),k+=(t*1e3-k)*.05,A+=1,A>120&&j<3&&k>26&&M(),D+=t,ul(y,S,t),ul(b,C,t),ul(x,w,t,22),(j<3||A%2==0)&&(l.uTemps.value=D,m.rotation.y=y.valor*.46+Math.sin(D*.07)*.06,m.rotation.x=b.valor*.28+x.valor*.14,m.position.x=.5-y.valor*.55,m.position.y=-b.valor*.3,_.position.z=Xc+x.valor*2.6,l.uForca.value=1-x.valor*.55,i.render(p,_)),O&&!document.hidden&&(T=window.requestAnimationFrame(ee))},N=()=>{T||!O||document.hidden||(E=0,T=window.requestAnimationFrame(ee))},P=()=>{T&&window.cancelAnimationFrame(T),T=0},te=e=>{S=e.clientX/window.innerWidth-.5,C=e.clientY/window.innerHeight-.5},ne=()=>{w=Math.min(1,Math.max(0,window.scrollY/Math.max(1,window.innerHeight)))},re=()=>{v(),ne()},ie=new IntersectionObserver(([e])=>{O=e.isIntersecting,O?N():P()},{threshold:0});ie.observe(r);let ae=()=>document.hidden?P():N(),F=t=>{t.preventDefault(),P(),e()};return window.addEventListener(`pointermove`,te,{passive:!0}),window.addEventListener(`scroll`,ne,{passive:!0}),window.addEventListener(`resize`,re),document.addEventListener(`visibilitychange`,ae),r.addEventListener(`webglcontextlost`,F),ne(),N(),()=>{P(),ie.disconnect(),window.removeEventListener(`pointermove`,te),window.removeEventListener(`scroll`,ne),window.removeEventListener(`resize`,re),document.removeEventListener(`visibilitychange`,ae),r.removeEventListener(`webglcontextlost`,F),u.nodes.dispose(),u.enllacos.dispose(),d.dispose(),f.dispose(),i.dispose()}},[t,e]),(0,Uc.jsx)(`canvas`,{ref:n,"aria-hidden":!0,className:`pointer-events-none size-full`,style:{maskImage:`radial-gradient(ellipse 72% 82% at 70% 46%, #000 8%, rgba(0,0,0,.5) 48%, transparent 84%)`,WebkitMaskImage:`radial-gradient(ellipse 72% 82% at 70% 46%, #000 8%, rgba(0,0,0,.5) 48%, transparent 84%)`}})}export{dl as default};